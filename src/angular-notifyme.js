 ...
 *
 * Author: Subash S
 * Website: http://subashselvaraj.com, https://github.com/sesubash/
 * Date Created: 26th Sep, 2015
 * Document: NotifyMe angular service
 * Credit to: "Shiv Kumar Ganesh" for his original Vanilla JS NotifyMe plugin at https://github.com/shivkumarganesh/NotifyMe
 */
angular.module('notifyme',[])
.factory('NotifyMe', function() {
  ...
  return {
    launch: function(title, options) {
      notifyme.NotifyMe(title, options).launch();
    }
  };
});
